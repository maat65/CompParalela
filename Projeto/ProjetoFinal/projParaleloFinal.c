...
int main(int argc, char *argv[]) {
    int n = 50000; // número de termos da série de Taylor a serem calculados
    int thread_count = 2;

    mpf_set_default_prec(200000); // seta a precisão da quantidade de numeros decimais
